                              ...
                              children: [
                                  ...
                                  child:  ClipRRect(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: Image(
                                        ...
                                        width: 50,
                                        fit: BoxFit.cover,
                                        image: AssetImage('${controller.teacherList[index].image}'),
                                      ),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text('Name: ${controller.teacherList[index].name}', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold),),
                                      SizedBox(height: 4.0),
                                      Text('Degree: ${controller.teacherList[index].degree}',  style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500),),
                                      SizedBox(height: 4.0),
                                      Text('Experience: ${controller.teacherList[index].experience}',  style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500),),
                                      SizedBox(height: 4.0),
                                      Text('E-mail: ${controller.teacherList[index].email}',  style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500),),
                                    ],
                                  ),
                                ),
