...
import 'package:new_project_work/ui_pages/student/homework/widget/upload_pop_up.dart';
...
class Choice {
  ...
  Choice({required this.onPress, required this.title, required this.icon});
}
          ...
          Flexible(
            ...
            child: GridView.count(
              ...
              children: List.generate(choice.length, (index) {
                return Center(
                  child: SelectCard(choices: choice[index]),
                );
              }),
            ),
          ),
